...
If you're compiling for iOS, you'll need to install CocoaPods for your project. If didn't install during initial setup, we recommend using [`pod-install`](https://www.npmjs.com/package/pod-install) to install it:
