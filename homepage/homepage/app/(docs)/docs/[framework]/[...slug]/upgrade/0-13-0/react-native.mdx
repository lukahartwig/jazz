...
pnpm install @op-engineering/op-sqlite react-native-mmkv @react-native-community/netinfo
pnpm install jazz-react-native jazz-react-native-media-images
...
- `OpSQLiteAdapter` for database storage (using [`@op-engineering/op-sqlite`](https://www.npmjs.com/package/@op-engineering/op-sqlite))
- `MMKVStoreAdapter` for key-value storage (using [`react-native-mmkv`](https://www.npmjs.com/package/react-native-mmkv))
...
`jazz-react-native` fully supports [the React Native New Architecture](https://reactnative.dev/docs/the-new-architecture/landing-page). This includes compatibility with:
