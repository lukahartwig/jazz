...
We're going to build a simple profile app. You'll see how to:
...
By the end of this guide, you'll have a simple app that you can use as a starting point for your own projects. If you'd like to see the complete example of what we'll build, see the [complete example app](https://github.com/garden-co/my-first-jazz-app).
...
For a complete example of what we've built, see the [complete example app](https://github.com/garden-co/my-first-jazz-app).
