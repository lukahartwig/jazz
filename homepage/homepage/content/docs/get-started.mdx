...
Start the development server with `pnpm run dev`. You should see the app running in your browser. (We've used `pnpm` in this example, but any package manager will work.)
