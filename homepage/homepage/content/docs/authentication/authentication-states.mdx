...
Jazz provides three distinct authentication states that determine how users interact with your app:

- [**Anonymous Authentication**](/docs/building-with-jazz/authentication#anonymous-authentication)
- [**Authenticated Account**](/docs/building-with-jazz/authentication#authenticated-account)
- [**Guest Mode**](/docs/building-with-jazz/authentication#guest-mode)

**Note:** For a conceptual overview of authentication states, see the [Building with Jazz - Authentication](/docs/building-with-jazz/authentication). This document focuses on implementation details and code examples.
...
- [Building with Jazz - Authentication](/docs/building-with-jazz/authentication) - Conceptual overview of authentication states
- [Provider Configuration](/docs/project-setup/providers/) - Complete provider configuration documentation