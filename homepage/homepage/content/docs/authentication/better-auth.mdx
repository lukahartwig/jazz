...
For documentation on how to configure Better Auth clients created via `newAuthClient`, read the [Better Auth documentation](https://www.better-auth.com/docs/introduction).
