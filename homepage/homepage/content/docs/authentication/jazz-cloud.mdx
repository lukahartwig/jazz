...
1. Register your application in the [Jazz Cloud Dashboard](https://dashboard.jazz.tools/).
  - The application will be assigned an authentication URL for every environment, including your application's development environment and an optional production environment.
...
const authClient = newAuthClient(authUrl);
...
const auth = useCloudAuth(authUrl);
