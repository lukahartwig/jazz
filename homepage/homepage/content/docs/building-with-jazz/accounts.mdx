...
Accounts are the foundation of user identity in Jazz. They serve as the entry point to all user data and enable collaboration between users. With [providers](/docs/building-with-jazz/providers) in place, the next step is understanding how users and their data are represented.
