...
Server Workers extend the Jazz collaboration model to server-side code. They enable you to add backend logic to your application while maintaining the familiar collaborative data model.
...
🎉 **Congratulations!** With Server Workers, you've completed the core journey of building applications with Jazz.
