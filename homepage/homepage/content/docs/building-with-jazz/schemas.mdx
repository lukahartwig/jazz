...
Behind the scenes, CoValues implement [Conflict-free Replicated Data Types (CRDTs)](https://crdt.tech/). Don't worry about the fancy name - it just means your data works well across multiple users and devices without constant server check-ins.
